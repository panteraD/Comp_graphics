...
void line (tgaImage *image, 
           ...
           int x1, int y1,
           tgaColor color);
void triangle(tgaImage *image, int *zbuffer, Vec3 *t0, Vec3 *t1, Vec3 *t2,Vec3 *uv0,Vec3 *uv1,Vec3 *uv2, float intensity, Model *cat);
...
*/
    ...
    int *zbuffer = malloc (sizeof (int) * width*height); //изменить тип на short
